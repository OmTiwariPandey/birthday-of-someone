...
const loveItems = [
  ...
  },
  {
    icon: Star,
    title: "Your Ambition",
    description: "Your ambition to achieve something big in life.",
  },
  {
    icon: Coffee,
    title: "Time spent",
    description: "Those perfect late night chats that made me blush all night.",
  },
  {
    icon: Music,
  ...
  },
  {
    ...
    description: "The unique way you see and capture the beauty in everything.",
  },
  {
    icon: Smile,
    title: "Your Smile",
